...
{
  LCD_SendCmd(0x80 | pos); // 1xxx xxxx, 0 (0 - 16) ilk satýr baþý, 64 (64 - 79)ikinci satýr baþý
}
...
void LCD_Init(void)
{
  ...
  LCD_SendCmd(0x06); // I/D=1 (cursor artma)
                     // S=0  The display does not shift if S is 0
